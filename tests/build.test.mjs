...
`,
    ...
    assert.match(homeHtml, /class="mode-balance-panel"/);
    assert.match(homeHtml, /class="stat-panel theme-map-panel"/);
    assert.match(homeHtml, /class="cluster-ledger"/);
    assert.match(homeHtml, /class="cluster-row"/);
    assert.match(homeHtml, /class="stat-panel tag-spectrum-panel"/);
    assert.match(homeHtml, /class="stat-panel activity-panel"/);
    assert.match(homeHtml, /class="activity-heatmap"/);
    assert.match(homeHtml, /data-activity-count="0"/);
    assert.match(homeHtml, /data-activity-count="4"/);
    assert.match(homeHtml, /class="archive-timeline"/);
    ...
    assert.doesNotMatch(homeHtml, /class="site-status-panel"/);
    assert.doesNotMatch(homeHtml, /class="project-map-cell"/);
    assert.doesNotMatch(homeHtml, /class="archive-density-chart"/);
    assert.doesNotMatch(homeHtml, /class="archive-rank-list"/);
    ...
    assert.match(siteCss, /\.mode-balance-panel/);
    assert.match(siteCss, /\.theme-map-panel/);
    assert.match(siteCss, /\.cluster-ledger/);
    assert.match(siteCss, /\.activity-heatmap/);
    assert.match(siteCss, /\.archive-timeline/);
